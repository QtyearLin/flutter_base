...
import 'file:///F:/github_project/flutter_app/lib/widget/app/app_pull_header.dart';

typedef OnRefreshLoadCallback = Future<
    void> Function( int page, EasyRefreshController controller, bool refresh);
...
class AppBaseRefreshWidget extends StatefulWidget {
  ...
  const AppBaseRefreshWidget({Key key,
    this.slivers,
